...
function Resume({}: Props) {
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center flex-parent mb-6 mx-auto">

        <div className="resume-tab bg-brand-grey md:w-[1200px] rounded-md mb-2">
        ...
        <div className="resume-tab bg-brand-grey md:w-[1200px] rounded-md mb-2">
          ...
          <ul className="mb-4 p-3">
            ...
            <li className="mb-1">- Completed a month-long virtual training in UI/UX design, delivering milestone projects including an e-commerce and health and wellness app prototype.</li>
          </ul>
        </div>
      </div>
    </>
